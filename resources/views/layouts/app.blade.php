    ...
    <div class="sidebar">
      <nav class="nav flex-column" id="sidebarMenu">
        ...
        <a class="nav-link" data-bs-toggle="collapse" href="#salesMenu" role="button"
          aria-expanded="false" aria-controls="salesMenu">
          <span>Sales</span>
        </a>
        <div class="collapse submenu" id="salesMenu" data-bs-parent="#sidebarMenu">
          <nav class="nav flex-column">
            <a class="nav-link" href="/rab">Rancangan Anggaran Biaya</a>
            <a class="nav-link" href="/kontrak">Kontrak Pelanggan Dedicated</a>
        ...
        <a class="nav-link" data-bs-toggle="collapse" href="#marketingMenu" role="button"
          aria-expanded="false" aria-controls="marketingMenu">
          <span>Marketing</span>
        </a>
        ...
        <!-- Technical Support -->
        <a class="nav-link" data-bs-toggle="collapse" href="#tsMenu" role="button"
          aria-expanded="false" aria-controls="tsMenu">
        ...
        <!-- Customer Relations -->
        <a class="nav-link" data-bs-toggle="collapse" href="#crMenu" role="button"
          aria-expanded="false" aria-controls="crMenu">
        ...
        <!-- HRD -->
        <a class="nav-link" data-bs-toggle="collapse" href="#hrdMenu" role="button"
          aria-expanded="false" aria-controls="hrdMenu">
          <span>HRD</span>
        </a>
