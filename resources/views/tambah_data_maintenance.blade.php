...
@section('title', 'Technical Support - Maintenance')

@section('page-title', 'Form Data Form Maintenance')

@section('content')
<div class="container">
    <div class="card shadow-sm border-0 rounded-3">
        <div class="card-body">
            <form action="{{ route('tambah_data_maintenance') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    <label class="form-label">Maintenance ke <span class="text-danger">*</span></label>
                    <input type="text" name="maintenance_ke" class="form-control" required>
                </div>
