...
@section('title', 'Technical Support - UATInternet')

@section('page-title', 'Form Data User Acceptance Testing Internet')

@section('content')
<div class="container">
    <div class="card shadow-sm border-0 rounded-3">
        <div class="card-body">
            <form action="{{ route('tambah_data_uatinternet') }}" method="POST">
                @csrf
